...
if (WITH_RUN_IN_PLACE)
    add_definitions(-DDEFAULT_NMLFILE="${CMAKE_INSTALLATION_PREFIX/configs/common/linuxcnc.nml}")
    add_definitions(-DDEFAULT_TOOLTABLE="${CMAKE_INSTALLATION_PREFIX/configs/sim/sim.tbl")
else()
    add_definitions(-DRUN_IN_PLACE=no)
    add_definitions(-DDEFAULT_NMLFILE="${CMAKE_INSTALLATION_PREFIX/share/common/linuxcnc.nml}")
    add_definitions(-DEMC2_HOME="${CMAKE_INSTALLATION_PREFIX}")
endif()
