...
inline const ::std::string& Value::v_bytes() const {
  ...
  return v_bytes_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline const ::std::string& Value::v_string() const {
  ...
  return v_string_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::machinetalk::PmCartesian* Value::mutable_carte() {
  set_has_carte();
  if (carte_ == NULL) {
    carte_ = new ::machinetalk::PmCartesian;
  }
